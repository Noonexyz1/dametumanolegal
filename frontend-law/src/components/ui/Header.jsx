...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-20">
        ...
        <nav className="rounded-b-3xl border-b-2 border-[#FFFFFF] bg-[#100C18] mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <Popover.Group className="hidden lg:flex lg:gap-x-12">
                ...
                <ScrollLink to="section3" smooth={true} duration={500} className="text-sm font-semibold leading-6 text-[#FFFFFF] cursor-pointer">Areas de practica</ScrollLink>
                <ScrollLink to="section4" smooth={true} duration={500} className="text-sm font-semibold leading-6 text-[#FFFFFF] cursor-pointer">Galeria</ScrollLink>
                <ScrollLink to="section5" smooth={true} duration={500} className="text-sm font-semibold leading-6 text-[#FFFFFF] cursor-pointer">Resultados</ScrollLink>
                <ScrollLink to="section6" smooth={true} duration={500} className="text-sm font-semibold leading-6 text-[#FFFFFF] cursor-pointer">Nosotros</ScrollLink>
                <ScrollLink to="section8" smooth={true} duration={500} className="text-sm font-semibold leading-6 text-[#FFFFFF] cursor-pointer">Contacto</ScrollLink>
                <a href="#" className="text-sm font-semibold leading-6 text-[#FFFFFF]">Calculador</a>
        ...
        <Dialog as="div" className="lg:hidden sticky top-0 z-50" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
