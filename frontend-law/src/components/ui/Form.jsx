...
export default function Form() {
    return (
        <div className=''>
            <h3 className='text-2xl text-white pt-4 pl-2 pb-2'>Formulario</h3>
            <div className='border border-white rounded-2xl p-8'>
                <form method="POST" action="#">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button
                            type="submit"
                            className="rounded-md bg-orange-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                            Save
                        </button>
                    </div>
